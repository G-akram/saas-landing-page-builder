...
export default function VerifyEmailContent(): React.JSX.Element {
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#0d1117]/80 p-8 text-center shadow-2xl shadow-black/50 backdrop-blur-xl">
          ...
          <div className="mt-6 space-y-3">
            <button
              ...
              className="w-full cursor-pointer rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
