...
import { badge, image, text } from './block-element-factories'

export const TESTIMONIALS_TEMPLATES: BlockTemplate[] = [
  {
    // Card grid with avatar images — 3 col, elevated cards
    ...
    createElements: () => [
      ...
      text(
        0,
        '"This platform completely transformed how we build landing pages. We ship 10× faster now."',
        {
          fontSize: 15,
          color: '#374151',
      ...
      text(0, 'Sarah Chen · Head of Growth, Acme', {
        fontSize: 13,
        fontWeight: 600,
        color: '#111827',
      ...
      text(
        1,
        '"The A/B testing alone paid for itself in the first month. Genuinely the best tool in our stack."',
        {
          fontSize: 15,
          color: '#374151',
          colorToken: 'text-secondary',
      ...
      image(1, 'Marcus Johnson avatar', { borderRadius: 9999, maxWidth: '40px', marginTop: 16 }),
      text(1, 'Marcus Johnson · Founder, LaunchKit', {
        fontSize: 13,
        fontWeight: 600,
        color: '#111827',
        colorToken: 'text-primary',
      ...
      text(
        2,
        '"We tried every page builder out there. This is the one we actually stuck with long-term."',
        {
          fontSize: 15,
          color: '#374151',
          colorToken: 'text-secondary',
      ...
      image(2, 'Alex Rivera avatar', { borderRadius: 9999, maxWidth: '40px', marginTop: 16 }),
      text(2, 'Alex Rivera · CTO, Streamline', {
        fontSize: 13,
        fontWeight: 600,
        color: '#111827',
        colorToken: 'text-primary',
  ...
  },
  {
    ...
    createElements: () => [
      ...
      text(
        0,
        'We tried every page builder out there. This is the one we stuck with. The editor is simply the best we have ever used — and our conversion rate agrees.',
        {
          fontSize: 24,
          fontWeight: 500,
          color: '#111827',
  ...
  {
    // Dark 2-col grid — dark background, subtle card slots
    ...
    createElements: () => [
      ...
      text(
        1,
        '"The A/B testing alone paid for itself in the first month. Incredible ROI on the subscription."',
        {
          fontSize: 15,
          color: '#cbd5e1',
          colorToken: 'text-secondary',
