            ...
            elements: [
              {
                ...
                styles: { fontSize: 48, fontWeight: 700, color: '#111827', textAlign: 'center', lineHeight: 1.2 },
              },
              {
                id: crypto.randomUUID(),
                type: 'text',
                slot: 1,
                content: { type: 'text', text: 'A beautiful page built with the landing page builder.' },
                styles: { fontSize: 18, fontWeight: 400, color: '#6b7280', textAlign: 'center', lineHeight: 1.6, maxWidth: '640px' },
              },
              {
                id: crypto.randomUUID(),
                type: 'button',
                ...
                styles: { fontSize: 16, fontWeight: 600, color: '#ffffff', backgroundColor: '#2563eb', borderRadius: 8, padding: { top: 12, bottom: 12, left: 32, right: 32 } },
              },
            ],
          },
          {
            ...
            elements: [
              ...
              },
              {
                ...
                styles: { fontSize: 16, fontWeight: 400, color: '#6b7280', textAlign: 'center', lineHeight: 1.6 },
              },
            ],
          },
          {
          ...
          },
          {
            ...
            elements: [
              ...
              },
              {
                ...
                styles: { fontSize: 16, fontWeight: 600, color: '#2563eb', backgroundColor: '#ffffff', borderRadius: 8, padding: { top: 12, bottom: 12, left: 32, right: 32 } },
              },
            ],
          },
          {
            ...
            elements: [
              {
                ...
                styles: { fontSize: 14, fontWeight: 400, color: '#9ca3af', textAlign: 'center', lineHeight: 1.5 },
              },
            ],
          },
        ],
